...
path_es = f"{parent_dir_path}/Data/Europarl Corpus/es-europarl.test.conll02"
...
with open(f"{parent_dir_path}/Data/Evaluation Results/europarl_es_spacy_eval.txt", "w") as outfile:
...
with open(f"{parent_dir_path}/Data/Evaluation Results/europarl_es_stanza_eval.txt", "w") as outfile:
