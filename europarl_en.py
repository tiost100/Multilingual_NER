...
with open(f"{dir_path}/Evaluation Results/europarl_en_spacy_eval.txt", "w") as outfile:
...
# note: the file path depends on the storage location of the file on the 
# computer, and can vary from computer to computer
with open(f"{dir_path}/Evaluation Results/europarl_en_stanza_eval.txt", "w") as outfile:
