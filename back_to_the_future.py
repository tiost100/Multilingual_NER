...
with open(f"{dir_path}/Back_To_The_Future/back_to_the_future_en_eval.txt", "w", encoding="latin-1") as outfile:
...
# Print the SpaCy results
with open(f"{dir_path}/Back_To_The_Future/back_to_the_future_es_eval.txt", "w", encoding="latin-1") as outfile:
